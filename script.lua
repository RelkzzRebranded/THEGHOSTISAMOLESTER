...
do
	...
	function FingerprintComponent:constructor(instance)
		...
		local marker = LocationMarker.new(_position + _vector3):setTitle(instance.Name):setColor(Color3.new(1, 0.5, 0)):setEnabled(true)
		self.marker = marker
		local _binding_3 = self
		local bin = _binding_3.bin
		bin:add(marker)
...
do
	...
	function CursedPossesionHolderComponent:constructor(instance)
		...
		local _vector3 = Vector3.new(0, 10, 0)
		local marker = LocationMarker.new(_position + _vector3):setTitle("Cursed Item"):setColor(Color3.new(1, 0, 0)):setEnabled(true)
		self.marker = marker
		local _binding_3 = self
		local bin = _binding_3.bin
		bin:add(marker)
